...
$col = 0;
    ...
    $objPHPExcel->getActiveSheet()->setCellValueExplicitByColumnAndRow($col, $row, "Societe");
    $col += 1;
    ...
    $col += 1;
    $objPHPExcel->getActiveSheet()->setCellValueExplicitByColumnAndRow($col, $row, "Objectif qualité");
    $col += 1;
    $objPHPExcel->getActiveSheet()->setCellValueExplicitByColumnAndRow($col, $row, "Réalisé");
...
$nom_fichier = "ecart_qualité_" . date("dmY") . ".xlsx";
